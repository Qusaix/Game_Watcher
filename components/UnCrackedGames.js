...
class UnCrackedGames extends React.Component
{
    constructor()
    {
        super();
    ...
    componentDidMount = ()=>
    {
        fetch('https://api.crackwatch.com/api/games?page=0&sort_by=release_date&is_released=true&is_cracked=false',{
            method:"GET"
        })
        .then(res=>res.json())
        .then((res)=>{
